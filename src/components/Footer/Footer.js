      ...
      <div className="container mx-auto px-4">
        <div className="flex flex-wrap justify-between items-start">
          <div className="w-full md:w-1/3 mb-8 md:mb-0">
            ...
            <p className="text-gray-400">Your go-to source for all things awesome. Stay connected with us for the latest updates and offers.</p>
          </div>
          <div className="w-full md:w-1/3 mb-8 md:mb-0">
            ...
            <li className="mb-2">
              ...
              <li className="mb-2">
                <Link to="/brand" className="text-gray-400 hover:text-white">Brand</Link>
              </li>
              <li className="mb-2">
                <Link to="/contact" className="text-gray-400 hover:text-white">Contact</Link>
              </li>
              <li className="mb-2">
                <Link to="/tour" className="text-gray-400 hover:text-white">Tour</Link>
              </li>
          ...
          <div className="w-full md:w-1/3 mb-8 md:mb-0">
            ...
            <p className="text-gray-400">Street #5, Sector 16, Gulshan-e-bahar, Orangi town, Karachi</p>
        ...
        <div className="mt-8 flex flex-col md:flex-row justify-between items-center">
          ...
          <div className="mb-4 md:mb-0">
            ...
            <form>
              ...
              />
              <button className="mt-2 md:mt-0 md:ml-2 px-4 py-2 bg-blue-600 hover:bg-blue-700 text-white">Subscribe</button>
            </form>
          </div>
        </div>
